...
var ETxSpec = p2ptrade.ProtocolObjects.ETxSpec
...
var mnemonic = fixtures.wallet.bob.mnemonic
var password = fixtures.wallet.bob.password
...
describe('P2PTrade EWCtrl', function(){
  ...
  it.skip('makeReplyTx', function(done){ // FIXME
    var tradeValue = 100000 // 1mBTC
    var maxfee = 50000 // 0.5 mBTC
    var our = {"color_spec": "", "value": tradeValue}
    var their = {"color_spec": gold["colorDescs"][0], "value": tradeValue}
    ewctrl.makeEtxSpec(their, our, function(error, etxSpec){
      if(error){ throw error }
